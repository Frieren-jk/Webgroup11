                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-8 mt-3">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Enter the Full Name" value = "${employeeDetails.employeeID}" >
                                            ...
                                            <div class="col-12 col-md-4 mt-3">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="firstName" placeholder="Enter the Position of the Employee" value = "${employeeDetails.firstName}"  >
                                                    <small id="usernameHelp"  class="form-text">Alphanumeric, must be between 4 - 12 characters.</small>
                                                </div> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-12 col-md-4  mt-5 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="middlename" name="middleName" placeholder="Enter the Office"  value = "${employeeDetails.middleName}" >
                                            ...
                                            <div class="col-12 col-md-4  mt-5 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="lastname" name="lastName" placeholder="Enter the Age" value = "${employeeDetails.lastName}"  >
                                            ...
                                            <div class="col-12 col-md-4  mt-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="address" placeholder="Enter the Start Date" value = "${employeeDetails.department}" >
                                        ...
                                        <div class="row ">
                                            <div class="col-12 col-md-4 me-auto mt-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="birthday" placeholder="Enter the Salary" value = "${employeeDetails.employmentStatus}" >
