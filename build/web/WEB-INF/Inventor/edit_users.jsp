...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Edit Users</title>
                        ...
                        <div class="col-12">
                            <div class="checkout_details_area clearfix">
                                ...
                                <div class="registration-form-wrapper">
                                    <form method="POST" action="${pageContext.request.contextPath}/inventory/update/user" class="py-3 needs-validation" id="regform" novalidate>
                                        <c:forEach var="user" items="${user}">
                                            <div class="row">
                                                <div class="col-12 col-md-6 mt-3">
                                                    <div class="form-group ">
                                                        <label for="username">Editing Username</label>
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-12 col-md-4  mt-5 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="middlename" name="middleName" placeholder="Enter your Middle Name" value="${user.middleName}" >
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-12 col-md-4 me-auto mt-5 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control bday" id="birthday" name="birthday" placeholder="Enter your Birthday MM-DD-YYYY (2005)"   value="${user.birthday}">
                                                ...
                                                <div class="col-12 col-md-4 me-auto mt-5 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="number" name="mobileNumber" placeholder="09 - Enter your Mobile Number"  value="${user.mobileNumber}">
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/update/form/user';
                                                                }
                                                            });
                                                        },
