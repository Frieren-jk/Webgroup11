...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Food 2</title>
                        ...
                        <div class="col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mt-50">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Pedigree Choice Cuts Wet Beef 22oz</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="single_product_thumb">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/product-img/prodetails/food 2 shop.png">
                                            <img class="d-block w-100" src="img/product-img/prodetails/food 2 shop.png" alt="First slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/food2';
                                                                }
                                                            });
                                                        },
