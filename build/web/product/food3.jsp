...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Food 3</title>
                        ...
                        <div class="col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mt-50">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Pedigree Schmackos for Dogs</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="single_product_thumb">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/product-img/prodetails/food 3 shop.png">
                                            <img class="d-block w-100" src="img/product-img/prodetails/food 3 shop.png" alt="First slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/food3';
                                                                }
                                                            });
                                                        },
