...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Clothes</title>
                    ...
                    <div class="widget category mb-50 sticky-top">
                        ...
                        <div class="categories-menu">
                            <ul>
                                ...
                                <li class="active"><a href="${pageContext.request.contextPath}/clothes">Clothes</a></li>
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img src="img/product-img/clothes/cloth 1 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/clothes/cloth 1 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                        ...
                        <div class="col-12">
                            ...
                            <nav aria-label="navigation">
                                <ul class="pagination justify-content-end mt-50">
                                    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/clothes">1</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/clothes';
                                                                }
                                                            });
                                                        },
