...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Litter Boxes</title>
                    ...
                    <div class="widget category mb-50 sticky-top">
                        ...
                        <div class="categories-menu">
                            <ul>
                                ...
                                <li class="active"><a href="${pageContext.request.contextPath}/litterboxes">Litter Boxes</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img src="img/product-img/litterboxes/litbox 1 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/litterboxes/litbox 1 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/litterboxes/litbox 2 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/litterboxes/litbox 2 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/litterboxes/litbox 3 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/litterboxes/litbox 3 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12">
                            ...
                            <nav aria-label="navigation">
                                <ul class="pagination justify-content-end mt-50">
                                    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/litterboxes">1</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
