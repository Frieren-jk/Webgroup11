                            ...
                            <div class="checkout_details_area mt-50 clearfix">
                                ...
                                <form action="#" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            <textarea name="comment" style="height: 10cm; resize: none;" class="form-control" id="comment" cols="30" rows="10" placeholder="Leave a comment about your order"></textarea>
                                        </div>
