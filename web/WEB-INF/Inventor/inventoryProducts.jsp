        ...
        <input type="hidden" id="userRole" value="${userRole}">
            ...
            <div class="container m-auto m-1 m-5 mb-auto ">
                <div class="cart-btn w-10 mt-1 mb-4">
                    <a href="${pageContext.request.contextPath}/inventory/add/form/product" class="btn amado-bt">Add Product</a>
                </div>
                <div class="cart-btn w-10 mt-1 mb-4" >
                                ...
                                <tbody>
                                    <c:forEach var="product" items="${AllProducts}">
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="${pageContext.request.contextPath}/inventory/update/form/product?productID=<c:out value='${product.productID}'/>" class="editBtn">
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/inventory/products';
                                                                }
                                                            });
                                                        },
