...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Cages</title>
                ...
                <div class="shop_sidebar_area sticky-top ">
                    ...
                    <div class="widget category mb-50 sticky-top">
                        ...
                        <div class="categories-menu">
                            <ul>
                                <li class="active"><a href="${pageContext.request.contextPath}/cages">Cages</a></li>
                        ...
                        <div class="col-12">
                            ...
                            <nav aria-label="navigation">
                                <ul class="pagination justify-content-end mt-50">
                                    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/cages">1</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/cages';
                                                                }
                                                            });
                                                        },
