...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Fur Real Pet Supplies - Foods</title>
                    ...
                    <div class="widget category mb-50 sticky-top">
                        ...
                        <div class="categories-menu">
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/leashes">Leashes</a></li>
                                ...
                                <li class="active"><a href="${pageContext.request.contextPath}/foods">Foods</a></li>
                            </ul>
                                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 1 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 1 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 2 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 2 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 3 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 3 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 4 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 4 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 5 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 5 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="img/product-img/foods/food 6 shop.png" alt="error">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="img/product-img/foods/food 6 shop_z.png" alt="error">
                                </div>
                                <!-- Product Description -->
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    <!-- Product Meta Data -->
                        ...
                        <div class="col-12">
                            ...
                            <nav aria-label="navigation">
                                <ul class="pagination justify-content-end mt-50">
                                    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/foods">1</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                                        ...
                                                        success: function () {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    window.location.href = '${pageContext.request.contextPath}/foods';
                                                                }
                                                            });
                                                        },
